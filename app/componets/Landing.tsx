...
function Landing() {
  return (
    <main className="flex flex-col items-center px-4">
      <h1 className="my-4 italic text-white text-[32px] sm:text-6xl text-center ">
        Pro League Predictions
      </h1>
      <Image
      ...
      <div className="max-w-3xl">
        <h2 className="mt-8 text-[18px] sm:text-2xl text-white text-center">
